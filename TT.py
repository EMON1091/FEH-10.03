...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 10.03
\33[1;37m==============================================""")
############------[ RANDOM NUM ]------#########
def Main():
	logo()
...
def random_dalvik_all_devices_super_full_2025(seed=None):
    if seed is not None:
        random.seed(seed)
    ...
    # 2025 MOST accepted version range
    FBAV = f"{random.randint(398, 455)}.0.0.{random.randint(5, 70)}.{random.randint(80, 220)}"
    FBBV = str(random.randint(20000000, 99999999))

    # Display profiles
    density = random.choice(["2.0","2.5","3.0","3.5"])
    width = random.choice(["720","1080","1440"])
    height = random.choice(["1600","1920","2400","2560"])

    # BD + Global Locale / Carrier mix
    FBLC = random.choice(["bn_BD","bn_BD","en_US","en_GB","en_IN"])
    FBCR = random.choice([
        # BD
        "Grameenphone","Grameenphone","Robi","Banglalink","Airtel","Teletalk",
        # Global
        "Vodafone","Jio","Airtel IN","T-Mobile","AT&T","Verizon","Telkomsel"
    ])

    # ALL WORKING DEVICES — 2024–2025 (GIANT SET)
    devices = (
        # Samsung A/M Series
        [("Samsung","Galaxy A03")] * 2 +
        [("Samsung","Galaxy A04")] * 2 +
        [("Samsung","Galaxy A13")] * 3 +
        [("Samsung","Galaxy A14")] * 7 +
        [("Samsung","Galaxy A15")] * 7 +
        [("Samsung","Galaxy A24")] * 6 +
        [("Samsung","Galaxy A34")] * 6 +
        [("Samsung","Galaxy A54")] * 6 +
        [("Samsung","Galaxy A55")] * 5 +
        [("Samsung","Galaxy M14")] * 5 +
        [("Samsung","Galaxy M33")] * 5 +

        # Samsung Flagship
        [("Samsung","Galaxy S20")] * 2 +
        [("Samsung","Galaxy S21")] * 3 +
        [("Samsung","Galaxy S21 FE")] * 6 +
        [("Samsung","Galaxy S22")] * 4 +
        [("Samsung","Galaxy S23")] * 4 +
        [("Samsung","Galaxy S23 Ultra")] * 4 +
        [("Samsung","Galaxy S24")] * 3 +

        # Xiaomi / Redmi / Poco
        [("Xiaomi","Redmi Note 10")] * 2 +
        [("Xiaomi","Redmi Note 11")] * 3 +
        [("Xiaomi","Redmi Note 12")] * 5 +
        [("Xiaomi","Redmi Note 13")] * 6 +
        [("Xiaomi","Poco M4 Pro")] * 3 +
        [("Xiaomi","Poco X4 Pro")] * 3 +
        [("Xiaomi","Poco X5 Pro")] * 4 +
        [("Xiaomi","Poco X6 Pro")] * 5 +
        [("Xiaomi","Poco F5")] * 5 +
        [("Xiaomi","Poco F6")] * 4 +
        ...
        [("Realme","Realme C33")] * 2 +
        [("Realme","Realme C55")] * 4 +
        [("Realme","Realme Narzo 50")] * 3 +
        [("Realme","Realme 10 Pro")] * 4 +
        [("Realme","Realme 11 Pro")] * 4 +
        [("Realme","Realme GT Neo 3")] * 3 +
        ...
        # OnePlus
        [("OnePlus","OnePlus Nord N20")] * 3 +
        [("OnePlus","OnePlus Nord CE 2")] * 3 +
        [("OnePlus","OnePlus 8T")] * 2 +
        [("OnePlus","OnePlus 9R")] * 3 +
        [("OnePlus","OnePlus 10R")] * 3 +
        ...
        # Infinix / Tecno (BD hot)
        [("Infinix","Infinix Hot 30")] * 3 +
        [("Infinix","Infinix Hot 40")] * 4 +
        [("Infinix","Infinix Note 30")] * 4 +
        [("Tecno","Tecno Spark 10")] * 3 +
        [("Tecno","Tecno Spark 20")] * 4 +
        [("Tecno","Tecno Pova 5")] * 4
    )
    ...
    # Android version
    FBSV = random.choice(["10","11","12","13","14"])

    # Stable global build props
    build = random.choice([
        "UP1A.231005.007",
        "UP1A.240205.002",
        "TQ3A.230901.001",
